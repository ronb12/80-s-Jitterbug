  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 space-y-8 text-zinc-400">
        <section>
          <h2 className="text-xl font-semibold text-white">1. Services &amp; What&apos;s Included</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-white">2. Venue &amp; Technical Requirements</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white">3. Deposit &amp; Confirmation</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white">4. Balance Due &amp; Late Payment</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white">5. Cancellation &amp; Rescheduling</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white">6. Equipment Damage &amp; Liability</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white">7. Use of Event Photos (Photo Release)</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-white">8. Entire Agreement &amp; Changes</h2>
          <p className="mt-2 leading-relaxed">
        ...
        <section className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-6">
          ...
          <p className="mt-2 leading-relaxed text-zinc-400">
            For questions about these booking terms, your quote, or payment:
          </p>
      ...
      <div className="mt-12 flex flex-wrap gap-4">
        <Link href="/booking" className="text-[var(--pink)] hover:underline">
          ← Back to booking
        </Link>
        <Link href="/terms" className="text-zinc-500 hover:text-[var(--pink)]">
          Terms of Service
        </Link>
